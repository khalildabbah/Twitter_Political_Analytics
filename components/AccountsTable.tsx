  ...
  return (
    <>
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6 dark:bg-gray-800 dark:border-gray-700">
        <h2 className="text-base sm:text-lg font-semibold text-gray-900 mb-3 sm:mb-4 dark:text-gray-100">
          Accounts
        </h2>
                  ...
                  <tr key={account.id} className="hover:bg-gray-50 dark:hover:bg-gray-900/40">
                    <td className="px-2 sm:px-4 py-2 sm:py-3">
                      <button
                        ...
                        className="text-blue-600 hover:text-blue-800 hover:underline font-medium dark:text-blue-400 dark:hover:text-blue-300 transition-colors text-left"
                      >
                        {account.displayName}
                      </button>
                    </td>
                    ...
                    <td className="px-2 sm:px-4 py-2 sm:py-3 text-gray-700 dark:text-gray-200">
                      {account.party}
                    </td>
